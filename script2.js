    ...
    async function loadGallery() {
        try {
            ...
            if (window.location.protocol === 'file:') {
                ...
                const localImages = [
  "A_ayudando_al_mundo.png",
  "Bienvenidos.png",
  "Creatividad sin limites.png",
  "Despertar_de_la_IA.png",
  "Entra al futuro de la IA.png",
  "Evolucion_de_la_IA.png",
  "Imagina_con_IA.png",
  "Inteligencia amplificada.png",
  "IoT.png",
  "Tutorial.png",
  "Velocidad_de_la_IA.png"
];
                renderGrid(localImages);
                return;
            }

            const response = await fetch('images.json2?t=' + new Date().getTime());
    ...
    function renderGrid(images) {
        ...
        images.forEach(imageName => {
            ...
            const comicPath = `videos/${baseName}.mp4`;
